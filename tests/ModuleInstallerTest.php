...
class ModuleInstallerTest extends TestCase
{
    ...
    public function it_supports_laravel_module_type_only()
    {
        ...
        $this->assertTrue($this->test->supports('act-module'));
    }
    ...
    public function it_returns_modules_folder_by_default()
    {
        ...
        $this->assertEquals('act/Name', $this->test->getInstallPath($mock));
    }
    ...
    public function it_can_use_compound_module_names()
    {
        ...
        $this->assertEquals('act/CompoundName', $this->test->getInstallPath($mock));
    }
